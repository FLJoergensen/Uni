...
gekoppelt(w11,w12,gegen).
gekoppelt(w31,w32,gleich).
gekoppelt(w21,w22,gleich).
gekoppelt(w15,w16,gleich).
gekoppelt(w23,w24,gleich).
gekoppelt(w27,w28,gegen).
gekoppelt(w34,w35,gleich).
gekoppelt(w36,w37,gleich).
gekoppelt(w38,w39,gleich).
gekoppelt(w41,w42,gleich).
gekoppelt(w52,w53,gleich).
gekoppelt(w44,w45,gegen).
